  ...
  const handleSend = async (text: string) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        responseText = data.answer || data.text || '';
        ...
        responseText = "Mari couldn't complete that request right now. Please retry.";

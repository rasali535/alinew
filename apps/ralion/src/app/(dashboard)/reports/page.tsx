...
export default function ReportsPage() {
  return (
    <TierAccessGate
      ...
      featureName="Advanced Reports & BI Analytics"
      description="Executive Reports & BI Analytics provide deep customer growth forecasts, sales pipeline cohort analysis, and exportable executive summaries. Upgrade to Professional to unlock."
    >
      <div className="flex flex-col gap-6 max-w-7xl mx-auto">
          ...
          <CardContent className="p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-3 shrink-0">
              <div className="text-right">
                <span className="text-[10px] text-zinc-400 uppercase tracking-widest block font-bold">Health Score</span>
                <span className="text-xl font-black text-emerald-400 font-mono">94.8 / 100</span>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Customer Ingestion Pace</CardTitle>
              <CardDescription>Total active client organizations MoM</CardDescription>
            </CardHeader>

...
assert(route.includes('const finalAnswer = shouldUseGroundedRouteFallback'), 'Facebook Growth must choose a final answer before response sanitation');
assert(route.includes('sanitizeMariModelOutput(finalAnswer)'), 'Facebook Growth must sanitize the selected final answer at API response boundary');

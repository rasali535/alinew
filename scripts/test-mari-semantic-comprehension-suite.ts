...
const TEST_CASES: TestCase[] = [
  ...
  // ─── 4. CREATIVE STUDIO & FLYERS (15 variations) ───
  {
    ...
    expectedKeywords: ['Creative Generation Job', 'FLYER', 'Ras Ali Labs', 'Ralion OS', 'Empowered to Prosper'],
  },
  {
    category: 'CREATIVE_STUDIO',
    prompt: 'Create a flyer for Ralion OS.',
    expectedIntent: 'CREATIVE_STUDIO',
    expectedKeywords: ['Creative Generation Job', 'FLYER', 'Ralion OS'],
  },
  {
    category: 'CREATIVE_STUDIO',
    prompt: 'I need launch artwork.',
    expectedIntent: 'CREATIVE_STUDIO',
    expectedKeywords: ['Creative Generation Job'],
  },
  {
    category: 'CREATIVE_STUDIO',

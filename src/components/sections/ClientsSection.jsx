      ...
      <div className="px-6 lg:px-12 mt-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {clients.map((client, index) => (
            <div
              key={index}
              className="flex items-center justify-center py-12 border border-white/10 rounded-lg hover:border-brand-gold/50 hover:bg-white/5 transition-all duration-300 group cursor-pointer"
            >

...
tenantProfileMap.set('ras-ali-labs', {
  ...
  industry: {
    value: 'Technology, Creative Production & Intelligent Software',
    sourceType: 'WEBSITE',
    confidence: 1.0,
    lastUpdated: new Date().toISOString(),
  },
  description: {
    value: 'Ras Ali Labs is a Botswana-based technology and creative company delivering intelligent platforms, cinematic productions, digital experiences and original sound.',
    sourceType: 'WEBSITE',
    confidence: 1.0,
    lastUpdated: new Date().toISOString(),
  },
  tagline: {
    value: 'Intelligent Platforms, Cinematic Productions, Digital Experiences and Original Sound',
    sourceType: 'WEBSITE',
    confidence: 1.0,
    lastUpdated: new Date().toISOString(),
  },
  valuePropositions: {
    value: [
      ...
      'Creator of flagship AI business operating system Ralion OS',
      'End-to-end digital experiences, original audio scoring, and workflow automation',
    ],
    sourceType: 'WEBSITE',
    confidence: 1.0,
    lastUpdated: new Date().toISOString(),
  ...
  targetMarkets: {
    value: ['Businesses, Brands, Creative Organizations, and Growth Enterprises'],
    sourceType: 'WEBSITE',
    confidence: 1.0,
    lastUpdated: new Date().toISOString(),
  },
  targetCustomers: {
    value: ['Business Founders, Marketing Directors, Content Creators, and Operational Executives'],
    sourceType: 'WEBSITE',
    confidence: 1.0,
    lastUpdated: new Date().toISOString(),
  },
  geography: {
    value: ['Botswana', 'Global'],
    sourceType: 'WEBSITE',
    confidence: 1.0,
    lastUpdated: new Date().toISOString(),
  },
  brandPositioning: {
    value: 'Technology and creative company based in Botswana',
    sourceType: 'WEBSITE',
    confidence: 1.0,
    lastUpdated: new Date().toISOString(),
  },
  brandVoice: {
    value: 'Visionary, Creative, Authoritative, Technologically Sophisticated',
    sourceType: 'MANUAL',
    confidence: 1.0,
    lastUpdated: new Date().toISOString(),
  },
  ...
  contentHash: 'hash-ral-default-v5',
  knowledgeVersion: 2,
  isVerified: true,

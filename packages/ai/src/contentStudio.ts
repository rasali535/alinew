...
export function generateMarketingCampaign(prompt: string, targetPlatform: string): GeneratedContent {
  return {
    ...
    captions: {
      LINKEDIN: `We are thrilled to present our newest operational milestone: ${prompt}. Empowering enterprise workflows with AI efficiency! #Ralion #BusinessAutomation`,
    ...
    hashtags: ['#RalionOS', '#MariAI', '#BusinessAutomation', '#EnterpriseSaaS'],
